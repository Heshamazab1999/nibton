...
class ProductDetailsScreen extends StatelessWidget {
  ...
  ProductDetailsScreen({super.key, this.name, this.description, this.price, this.quantity, this.image, this.size, this.color});
          ...
          children: [
            Center(
                child: Container(
                  ...
                  height: 180.h,
                  child:
            productDetailsController.productDetailsModel.d
                )
            ),
            DotsIndicator(
              dotsCount: 3,
